...
public class ProductServcice { //Atributos de la tabla de la base de datos
    private int id; 
    private String name; 
    ...
    public ProductServcice() {} //Constructor vacio, obligatorio 

    public ProductServcice(String name, double price, int quantity, String category) {//Constructor lleno
        this.name = name;
